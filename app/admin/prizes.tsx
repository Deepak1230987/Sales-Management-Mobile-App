...
export default function PrizesPage() {
  ...
  const renderPrizeItem = ({ item, index }: { item: Prize; index: number }) => (
    <TouchableOpacity
      style={[styles.prizeItem, !item.isActive && styles.inactivePrize]}
      onPress={() => router.push(`/admin/prize-form?prizeId=${item.id}`)}
    >
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.fixedHeaderContainer}>
        <View style={styles.header}>
          <TouchableOpacity
            ...
            onPress={() => router.replace("/admin/claims")}
          >
      ...
      <View style={styles.fabContainer}>
        <TouchableOpacity
          style={styles.fab}
          onPress={() => router.push("/admin/prize-form?fresh=true")}
        >
