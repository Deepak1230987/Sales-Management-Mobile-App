  ...
  const renderTransactionItem = ({
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => router.push(`/admin/sale-details?saleId=${item.id}`)}
      >
            ...
            <View style={styles.quickLinksContainer}>
              ...
              <View style={styles.quickLinks}>
                <TouchableOpacity
                  ...
                  onPress={() => router.push("/admin/add-sale?fresh=true")}
                >
                  <View
                    style={[
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    flex: 1,
    marginTop: 140, // Add space for the fixed header and tabs
  },
  loadingContainer: {
    flex: 1,
  ...
  balancePaid: {
    color: "#4CAF50", // Green for paid/no balance
  },
  transactionDate: {
    fontSize: 12,
    color: "#888",
